...
class TestEnrichment(unittest.TestCase):
    ...
    def test_gsea(self):
        ...
        # check result
        self.assertEqual(r.table.sort_values("nes").iloc[0].name, 'Glycerolipid metabolism_Homo sapiens_hsa00561')
        self.assertAlmostEqual(r.table.sort_values("nes").iloc[0].nes, -1.8, places=1)
