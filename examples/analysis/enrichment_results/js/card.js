...
var config = {"plot1": {"type": "chart", "snap": {"tooltip": {"trigger": "axis", "axisPointer": {"type": "shadow"}}, "grid": {"top": "5%", "left": "3%", "right": "12%", "bottom": "3%", "containLabel": true}, "yAxis": {"splitLine": {"show": false}, "data": ["catalytic activity", "transferase activity", "protein modification process", "cellular protein modification process", "protein phosphorylation", "palmitoyl hydrolase activity", "palmitoyl-(protein) hydrolase activity", "phosphorylation"], "type": "category"}, "color": ["#F2F2F2"], "xAxis": {"splitLine": {"show": false}, "lineColor": "transparent", "type": "value", "boundaryGap": [0, 0.01], "name": "-lg(p_bonferroni)"}, "series": [{"data": [13.319806009259302, 11.556529137977249, 4.307572801910292, 4.307572801910292, 3.9213901653036336, 3.083141235300246, 3.083141235300246, 2.2310746644362487], "type": "bar", "name": "-lg(p_bonferroni)"}]}, "detail": {"method": "ORA"}}, "plot0": {"type": "chart", "snap": {"tooltip": {"trigger": "axis", "axisPointer": {"type": "shadow"}}, "grid": {"top": "5%", "left": "3%", "right": "12%", "bottom": "3%", "containLabel": true}, "yAxis": {"splitLine": {"show": false}, "data": ["catalytic activity", "transferase activity", "protein modification process", "cellular protein modification process", "protein phosphorylation", "palmitoyl hydrolase activity", "palmitoyl-(protein) hydrolase activity", "phosphorylation"], "type": "category"}, "color": ["#F2F2F2"], "xAxis": {"splitLine": {"show": false}, "lineColor": "transparent", "type": "value", "boundaryGap": [0, 0.01], "name": "-lg(p_bonferroni)"}, "series": [{"data": [13.319806009259302, 11.556529137977249, 4.307572801910292, 4.307572801910292, 3.9213901653036336, 3.083141235300246, 3.083141235300246, 2.2310746644362487], "type": "bar", "name": "-lg(p_bonferroni)"}]}, "detail": {"method": "ORA"}}};
