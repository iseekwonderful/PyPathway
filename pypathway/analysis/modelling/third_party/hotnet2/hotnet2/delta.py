...
def network_delta_wrapper(xxx_todo_changeme):
    (network_path, infmat_name, index2gene, heat, sizes, directed,
                           selection_function, verbose) = xxx_todo_changeme
...
def heat_delta_wrapper(xxx_todo_changeme1):
    (infmat, index2gene, heat_permutation, directed, sizes, selection_function) = xxx_todo_changeme1
