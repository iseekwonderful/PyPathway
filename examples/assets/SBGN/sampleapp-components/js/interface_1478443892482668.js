...
var configFile = "../SBGN/sampleapp-components/data/config_1478443892482668.json";
...
function init_hook() {
    ...
    var path_to_xml = "../sampleapp-components/data/pathway_1478443892482668.xml";
                ...
                for (var x in config["connection"]){
                    ...
                    for (var t in config["connection"][x][1]){
                        if (t == "target-style" && ! (config["connection"][x][1][t] == undefined)){
                            ...
                            // var node_target = cy.$("#" + config["connection"][x][0]);
                            // additionalScale.push([node_target, node_target.css("width"),
                            // node_target.css("height")]);
                            // node_target.css("width", parseFloat(node_target.css("width")) *
                            //     parseFloat(config["connection"][x][1][t]));
                            // node_target.css("height", parseFloat(node_target.css("height")) *
                            //     parseFloat(config["connection"][x][1][t]));
                        }else {
